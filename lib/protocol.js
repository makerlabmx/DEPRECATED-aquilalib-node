...
var Protocol = function()
{
	...
	this.net = new Net();
	// Should get this from bridge, TODO
	...
	this.net.on("ready", function()
	{
		...
		setTimeout(function(){ self.net.mac.bridge.getLongAddress(); }, 1500);	// not really needed because bridge sends it at start...
...
Protocol.prototype.send = function(protoPacket)
{
	...
	packet.destPan.writeUInt16LE(Protocol.PAN, 0);
